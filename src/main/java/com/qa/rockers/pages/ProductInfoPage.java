...
import com.qa.rockers.utils.ElementUtil;
...
public class ProductInfoPage {
	...
	public Map<String, String> getProductInfo() {
		// productInfoMap = new HashMap<String, String>();    // will not maintain the order
		productInfoMap = new LinkedHashMap<String, String>(); //storing data in UI order
		// productInfoMap = new TreeMap<String, String>();  //storing data in sorted or alphabetical order
